...
<div class="title">APPLICATION PAGE </div>
		...
		<div id="left">
	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
	          <ul class="TabbedPanelsTabGroup">
	            <li class="TabbedPanelsTab style2" tabindex="0">Enter Personal Details</li>
	            <!-- <li class="TabbedPanelsTab style2" tabindex="0">Manage Staff</li> -->
              </ul>
	          <div class="TabbedPanelsContentGroup">
	            <div class="TabbedPanelsContent">
	              <form id="form1" name="form1" method="post" enctype='multipart/form-data' action="apply2.php">
	            ...
	            <div class="TabbedPanelsContent">
	              <table width="100%" border="1"  >
                    <tr>
                      ...
                      <th height="32"><div align="left" class="style9 style5"><strong>Class</strong></div></th>
                      <th  class="style3"><div align="left" class="style9 style5"><strong>Email</strong></div></th>
